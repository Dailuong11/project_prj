<%-- 
    Document   : signup
    Created on : Mar 8, 2022, 11:55:49 PM
    Author     : Vu Dai Luong
--%>
                                    ...
                                    <div class="card-body">
                                        <form action="signup" method="post">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input name="comfirmpass" class="form-control" id="inputPasswordConfirm" type="password" placeholder="Confirm password" />
                                                        <label for="inputPasswordConfirm">Confirm Password</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="mt-4 mb-0">
                                                <button class="d-grid"><a class="btn btn-primary btn-block">Create Account </a></button>
                                            </div>
                                        </form>
                                    </div>
